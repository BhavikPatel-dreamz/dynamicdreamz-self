export const astraThemeCustomizationContent = {
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "This theme uses vanilla JavaScript to enhance performance.",
        icon: "/assets/astra-theme-customization/features/no-jquery-dependency.svg",
        iconAlt: "No jQuery Dependency Icon",
      },
      {
  ...
  benefits: {
    title: "Benefits of Astra Theme Customization",
    subtitle:
  ...
  services: {
    title: "Our Astra Theme Customization Services",
    subtitle:
