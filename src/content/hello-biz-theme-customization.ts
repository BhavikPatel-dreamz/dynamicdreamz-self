export const helloBizThemeCustomizationContent = {
  hero: {
    ...
    description:
      "Get Started with Hello Biz Theme Customization Service to enhance your website. Are you looking for a clean, business-focused website design? The Hello Biz WordPress theme provides a perfect base for professional websites. At <strong>Dynamic Dreamz,</strong> we help you fully customize the Hello Biz theme to match your brand. Whether you’re a startup, small business, or agency, our customization service will give your website a modern look, faster speed, and better user experience.",
  ...
  features: {
    title: "Features Of Hello Biz Theme",
    subtitle:
  ...
  benefits: {
    title: "Benefits of Hello Biz  <br> Theme Customization",
    subtitle:
    ...
    items: [
      ...
      },
      {
        ...
        description: "We help you customize the design to fit your business branding.",
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Improve loading speed and user experience to optimize your performance.",
  ...
  whyChoose: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "We follow a tried-and-tested process to ensure you will get quality work only.",
