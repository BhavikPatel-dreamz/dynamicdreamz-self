...
export const shopifyDevelopmentPuneContent = {
  sectionCopy: {
  ...
  faqs: [
    {
      ...
      answer:
        "A Shopify development agency specializes in designing, developing, and managing Shopify stores. It provides services such as theme customization, app integration, and migration to help businesses succeed online.",
    },
    {
      question: "Why choose Shopify for your business?",
      answer:
        "Shopify simplifies online selling with its intuitive platform, customization options, and scalability. It’s a secure and efficient choice for businesses looking to expand or establish their eCommerce presence.",
    },
    {
      question: "What is the price of creating a Shopify store?",
      answer:
        "Development costs vary depending on the complexity and features of the store. While simple stores are more affordable, advanced projects with custom features require a higher investment.",
    },
    {
      question: "What support do you provide after launching the website?",
      answer:
        "We offer post launch support, including troubleshooting, updates, and performance optimization, ensuring your store remains functional and up to date.",
    },
    {
      question: "How do I get started?",
      answer:
        "Simply contact Dynamic Dreamz with your requirements. As the best Shopify development company in Pune, so We’ll schedule a consultation to understand your vision and guide you through the process of creating your dream Shopify store.",
    },
  ],
