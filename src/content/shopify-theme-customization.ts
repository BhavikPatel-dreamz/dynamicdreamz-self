...
export const shopifyThemeCustomizationContent = {
  "hero": {
    "title": "Shopify ThemeCustomization Services",
  ...
  "brands": {
    "title": "Trusted byLeading Brands",
    "items": [
      {
  ...
  "services": {
    ...
    "subtitle": "We provide a range of Shopify theme customization services to make your online store stand out:",
    "items": [
      {
        "title": "Theme Selection and Installation",
        "description": "We help you choose the perfect theme for your store and handle the installation process.",
      ...
      },
      {
        ...
        "description": "Ensure your mobile friendly store looks great on any device.",
        "icon": "/assets/shopify-theme-customization/services/responsive-design.svg"
      },
      {
        "title": "Advanced Features Integration",
        "description": "We integrate advanced features such as custom sliders, popups, product filters, and more to enhance functionality.",
        "icon": "/assets/shopify-theme-customization/services/advanced-features-integration.svg"
      },
      {
        "title": "Performance Optimization",
        "description": "Optimize your theme for faster load times and better performance.",
        "icon": "/assets/shopify-theme-customization/services/performance-optimization.svg"
      },
      {
        "title": "Ongoing Support and Maintenance",
        "description": "We provide continuing support to ensure your store remains updated and runs smoothly.",
        "icon": "/assets/shopify-theme-customization/services/ongoing-support-and-maintenance.svg"
      }
    ]
  },
  "whyNeed": {
    "title": "Why do you need ShopifyTheme customization services?",
    "subtitle": "A typical Shopify theme might not fully meet your business requirements and reflect brand identity.With our Shopify theme customization services, you get a store designed to deliver the best userexperience, making it easier for customers to navigate and shop. A customized store also enhancesSEO, user engagement, and conversion rates, giving your business a competitive edge in eCommerce. Here are some key points why you need Shopify theme customization services:",
    "items": [
      {
        "title": "Need Extra Functionality",
        "description": "It\u2019s not necessary that a pre built theme can fulfill your business needs. To add advanced features like custom filters, product sliders, and dynamic popups, consider theme customization services.",
        "icon": "/assets/shopify-theme-customization/services/theme-selection-and-installation.svg"
      },
      {
        "title": "New Theme Migration",
        "description": "A new theme arrived in the Shopify theme store; you previewed it and liked it. You find an opportunity to improve user experience. Then, we can help you migrate your current theme to a new one.",
        "icon": "/assets/shopify-theme-customization/why-need/new-theme-migration.svg"
      },
      {
        "title": "Want to Match With Branding",
        "description": "A pre built theme can not match your branding. You need to customize your theme to match imagery, color, logo, typography, tone of voice, and messaging.",
        "icon": "/assets/shopify-theme-customization/why-need/want-to-match-with-branding.svg"
      },
      {
        "title": "Need Improved Performance",
        "description": "If your current theme can\u2019t perform as per your expectations, then you can customize your theme or get a new one and customize it to your satisfaction to get improved performance.",
        "icon": "/assets/shopify-theme-customization/why-need/need-improved-performance.svg"
      }
    ]
  },
  "benefits": {
    "title": "Benefits of the ShopifyTheme Customization Service",
    "subtitle": "",
    "items": [
      {
        "title": "Fully Customizable Store",
        "description": "Tailor every aspect of your store to suit your brand and business needs.",
      ...
      },
      {
        ...
        "description": "Stand out with a design that reflects your brand's personality.",
        "icon": "/assets/shopify-theme-customization/benefits/unique-brand-identity.svg"
      },
      {
        "title": "Improved User Experience",
        "description": "Enhance navigation and usability to keep customers engaged.",
        "icon": "/assets/shopify-theme-customization/benefits/improved-user-experience.svg"
      },
      {
        "title": "Multiple Third party Apps",
        "description": "Easily integrate third party apps to enhance functionality.",
        "icon": "/assets/shopify-theme-customization/benefits/multiple-third-party-apps.svg"
      },
      {
        "title": "Higher Conversion Rates",
        "description": "Tailored designs can increase customer engagement and sales.",
        "icon": "/assets/shopify-theme-customization/benefits/higher-conversion-rates.svg"
      },
      {
        "title": "Mobile Optimization",
        "description": "Make sure that every device can view and use your business with ease.",
        "icon": "/assets/shopify-theme-customization/benefits/mobile-optimization.svg"
      },
      {
        "title": "SEO Friendly",
        "description": "Custom themes are optimized for search engines, helping improve your online visibility.",
        "icon": "/assets/shopify-theme-customization/benefits/seo-friendly.svg"
      },
      {
        "title": "Safe and Secure Payments",
        "description": "Implement secure payment gateways to protect customer transactions.",
        "icon": "/assets/shopify-theme-customization/benefits/safe-and-secure-payments.svg"
      },
      {
        "title": "Zero Maintenance Cost",
        "description": "Enjoy a low maintenance store with a custom built theme.",
        "icon": "/assets/shopify-theme-customization/benefits/zero-maintenance-cost.svg"
      },
      {
        "title": "Scalability and Flexibility",
        "description": "Your store grows with your business, adapting to changes smoothly.",
  ...
  "process": {
    ...
    "steps": [
      {
        "title": "Consultation",
        "description": "We start with a detailed consultation to understand your needs and vision.",
        "icon": "/assets/shopify-theme-customization/process/consultation.svg"
      },
      {
        "title": "Design Mockups",
        "description": "Our designers create mockups for your review and feedback.",
        "icon": "/assets/shopify-theme-customization/process/design-mockups.svg"
      },
      {
        "title": "Development",
        "description": "Once approved, we begin the development process, bringing the design to life.",
        "icon": "/assets/shopify-theme-customization/process/development.svg"
      },
      {
        "title": "Testing",
        "description": "We thoroughly test the custom theme to ensure it functions perfectly on all devices and browsers.",
        "icon": "/assets/shopify-theme-customization/process/testing.svg"
      },
      {
        "title": "Launch",
        "description": "We assist with launching the new theme and ensure everything runs smoothly.",
        "icon": "/assets/shopify-theme-customization/process/launch.svg"
      },
      {
        "title": "Post Launch Support",
        "description": "Our team is available for any post launch support or maintenance needed.",
  ...
  "themes": {
    ...
    "subtitle": "At Dynamic Dreamz, we provide expert customization services for a widerange of Shopify themes.\n                    Whether you're using a free or premium theme,we tailor it to fit your brand and business\n                    requirements. Below are some ofthe popular Shopify themes we specialize in customizing:",
    "items": [
      {
  ...
  "whyChoose": {
    "title": "Why Choose Dynamic Dreamz ForShopify Theme Customization?",
    "subtitle": "At Dynamic Dreamz, we ensure your Shopify store reflects your brand andmeets your business goals. Here\u2019s why you should choose us:",
    "items": [
      {
        "title": "Expert Team",
        "description": "We have experienced developers for your Shopify theme customization and development.",
        "icon": "/assets/shopify-theme-customization/why-choose/expert-team.svg"
      },
      {
        "title": "Proven Process",
        "description": "We guarantee your store is developed according to your demands by going through a step by step process.",
        "icon": "/assets/shopify-theme-customization/why-choose/proven-process.svg"
      },
      {
        "title": "Ongoing Support",
        "description": "We offer post launch support to keep your store updated and running smoothly.",
        "icon": "/assets/shopify-theme-customization/why-choose/ongoing-support.svg"
      },
      {
        "title": "Client Focused Approach",
        "description": "We work closely with you to understand your requirements and vision.",
    ...
    "items": [
      {
        ...
        "answer": "Shopify theme customization involves modifying a Shopify theme to suit your brand\u2019s specific design and functionality needs. It can include changes to layout, colors, fonts, features, and more to create a unique store that aligns with your business."
      },
      {
        "question": "Why should I customize my Shopify theme?",
        "answer": "Customizing your Shopify theme helps your store stand out from competitors, improves user experience, and can lead to higher conversion rates. A custom theme allows you to tailor the design and functionality to your brand\u2019s requirements and goals."
      },
      {
        "question": "How long does the customization process take?",
        "answer": "The time required for theme customization can vary depending on the complexity of the changes and your project\u2019s specific requirements. Generally, the theme customization process can take a few days to several weeks. We will provide a timeline after understanding your requirements during the initial consultation."
      },
      {
        "question": "Can I update the theme myself after customization?",
        "answer": "You can update and change your theme once the customization is complete. We can also provide training and documentation to help you manage your theme. Additionally, our team is available for ongoing support if you need further assistance."
      },
      {
        "question": "Can you customize a theme I have already purchased?",
        "answer": "Yes, we can customize any Shopify theme, whether it is one you have already purchased or one we recommend based on your needs. We will work with the existing theme to modify it to achieve your desired look and functionality."
      },
      {
      ...
      {
        "question": "What do you provide in Shopify theme customization service?",
        "answer": "Our Shopify theme customization service includes the following:Theme selection and installationCustom design and brandingResponsive design for mobile optimizationIntegration of advanced featuresPerformance optimizationOngoing support and maintenance"
      },
      {
        "question": "Will my store be down during the customization process?",
        "answer": "We strive to minimize any downtime during the customization process. To ensure a smooth transition, first, we make most changes on a staging site and then deploy them to your live site. We will work with you to schedule any necessary downtime to minimize the impact on your business."
      },
      {
        "question": "After the theme customization, do you offer support?",
        "answer": "We offer ongoing support and maintenance services to keep your store updated and perform optimally. Our team is available to assist with any issues or additional customizations you may need in the future."
      },
      {
        "question": "How much does Shopify theme customization cost?",
        "answer": "The complexity and scope of the project determine how much customizing a Shopify theme will cost. We offer different packages to suit various budgets and needs, and we can provide a custom quote after discussing your specific requirements. Contact us for a free consultation to get a detailed estimate."
      },
      {
        "question": "Can I customize my Shopify theme, or do I need a new one?",
        "answer": "You can customize an existing Shopify theme to fulfill your requirements. Suppose your current theme does not offer enough flexibility. In that case, we can extend it or recommend a new one better suited to your goals."
      }
    ]
  }
} as const;
