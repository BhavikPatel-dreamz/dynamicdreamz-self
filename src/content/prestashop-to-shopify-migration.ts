...
export const prestashopHeroContent: ServiceHeroContent = {
  ...
  reviews: [
    ...
    },
    {
      ...
      rating: "5.0",
      logoSrc: "/assets/reviews/goodfirms_review_services.svg",
...
export const prestashopConsiderationsContent: TwoColCenterImageContent = {
  ...
  description:
    "Migrating from PrestaShop to Shopify is a significant step, and proper<br> planning is necessary for a smooth migration. Here are vital things to<br> consider before starting the migration process.",
  centerImage: {
