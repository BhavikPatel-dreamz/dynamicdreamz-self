...
export function Eyebrow<T extends ElementType = "p">({
  ...
  return (
    <Component
      className={cn(
        !unstyled && "items-center text-[13px] leading-none font-semibold uppercase before:mr-3 before:block before:shrink-0 before:bg-brand-red before:content-[''] max-[767px]:text-xs",
