...
export function HiringHeroSection({
  ...
  className = "inner-hero-sec relative overflow-hidden bg-white pt-[215px] pb-20 max-[991px]:pt-[140px] max-[767px]:pb-10",
  hideReview = false,
  ...
  return (
    <section className={className}>
      <Container>
        ...
        <div className="total-deliver-wrap mt-15 flex items-center justify-between max-[1199px]:justify-center max-[991px]:mt-12.5 max-[767px]:flex-col">
          {content.stats.map((stat) => (
            <div
              className="deliver-col ml-12.25 border-l-[1.3px] border-[#efefef] pl-12.25 text-center first:ml-0 first:border-l-0 first:pl-0 max-[1199px]:ml-7.5 max-[1199px]:pl-7.5 max-[1199px]:first:ml-0 max-[1199px]:first:pl-0 max-[991px]:ml-4.5 max-[991px]:pl-4.5 max-[767px]:mb-5 max-[767px]:ml-0 max-[767px]:w-full max-[767px]:border-0 max-[767px]:pb-5 max-[767px]:pl-0 max-[767px]:last:mb-0 max-[767px]:last:pb-0 max-[767px]:not-last:border-b-[1.3px] max-[767px]:not-last:border-[#efefef]"
              key={stat.label}
            >
              <strong className="mb-1.25 block font-sans text-[44px] leading-13.75 font-bold tracking-[-.88px] text-ink max-[1199px]:text-[34px] max-[1199px]:leading-normal max-[991px]:mb-2.5 max-[991px]:text-[26px] max-[767px]:text-[30px]">
                {stat.value}
              </strong>
              <span className="mx-auto mt-1 block text-lg font-medium leading-6 text-muted max-[991px]:text-xs max-[767px]:text-base max-[767px]:leading-[27.2px]">
                {stat.labelLines
