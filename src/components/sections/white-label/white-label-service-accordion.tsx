            ...
            return (
              <article
                className={cn(
                  ...
                  columnIndex === 1 && isLastInColumn && "max-[991px]:border-b-0",
                )}
                key={service.title}
              >
                <button
                  className={cn(
                    "flex w-full cursor-pointer items-center border-0 bg-transparent py-5 text-left select-none max-[1199px]:py-[18px] max-[991px]:py-[15px]",
                    itemIndex === 0 && "!pt-0",
                    columnIndex === 1 && itemIndex === 0 && "max-[991px]:!pt-[15px]",
                  )}
                  id={triggerId}
                  type="button"
                ...
                >
                  <Image
                    className="mr-[18px] size-[52px] shrink-0 rounded-[15px] object-contain max-[1199px]:mr-[15px] max-[1199px]:size-12 max-[991px]:mr-2.5 max-[991px]:size-10 max-[767px]:size-[30px]"
                    src={service.icon}
                    alt=""
                    width={52}
                    height={52}
                  ...
                  <span
                    className="flex size-8 shrink-0 items-center justify-center rounded-lg bg-white/10 pb-0.5 text-[28px] leading-none font-normal text-white transition-all duration-300 max-[1199px]:size-7 max-[1199px]:text-2xl max-[991px]:size-6 max-[991px]:text-xl max-[767px]:size-[22px]"
                    aria-hidden="true"
                  >
                    {isOpen ? "−" : "+"}
                  </span>
