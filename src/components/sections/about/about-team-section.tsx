    ...
    <div className="-mx-2 flex flex-wrap max-[767px]:mx-0">
      {people.map((person) => (
        <article className="mb-[30px] w-1/4 px-2 text-center max-[992px]:w-1/3 max-[767px]:w-full max-[767px]:px-0" key={person.name}>
          ...
          <div className="mt-6 max-[1199px]:mt-5 max-[992px]:mt-[15px]">
            <h3 className="mb-[5px] text-xl leading-[27px] font-bold max-[1199px]:text-[18px]">{person.name}</h3>
            <p className="text-[15px] leading-[22px] font-medium text-muted italic max-[1199px]:mx-7 max-[992px]:mx-2.5 max-[767px]:mx-0">{person.role}</p>
          </div>
        </article>
      ))}
    </div>
