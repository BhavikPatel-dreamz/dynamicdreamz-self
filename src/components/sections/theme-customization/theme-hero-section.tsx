        ...
        >
          <div className="left-col w-1/2 pb-[50px] max-[991px]:w-full max-[991px]:text-center max-[991px]:pb-8">
            <div className="inner-hero-content">
              ...
              <p className="mt-6 mb-6 text-lg font-medium leading-[34.2px] text-muted max-[1199px]:text-base max-[1199px]:leading-[30.4px]">
                {formatBrText(content.description, "max-[1199px]:hidden")}
              </p>
              {content.secondaryDescription && (
                <p className="mt-4 mb-6 text-lg font-medium leading-[34.2px] text-muted max-[1199px]:text-base max-[1199px]:leading-[30.4px]">
