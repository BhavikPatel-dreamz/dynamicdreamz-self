      ...
      <Container className="max-[575px]:px-4">
        ...
        <div className="grid grid-cols-6 gap-[30px] max-[991px]:grid-cols-2 max-[991px]:gap-5 max-[767px]:grid-cols-1 max-[767px]:gap-7.5">
          {whiteLabelWebsiteDesignAiCapabilities.map((item, index) => (
            <article
              className={cn(
                "col-span-2 rounded-[15px] border border-[#efefef] bg-cream px-[25px] py-[50px] text-center max-[991px]:col-span-1 max-[767px]:py-10",
                index === 3 && "min-[992px]:col-start-2",
                index === whiteLabelWebsiteDesignAiCapabilities.length - 1 &&
                "max-[991px]:col-span-2 max-[991px]:mx-auto max-[991px]:w-[calc(50%-10px)] max-[767px]:col-span-1 max-[767px]:w-full",
              )}
              key={item.title}
            >
            ...
            <article className="relative text-center max-[767px]:text-left before:max-[767px]:absolute before:max-[767px]:top-[30px] before:max-[767px]:left-[-26px] before:max-[767px]:size-2.5 before:max-[767px]:rounded-full before:max-[767px]:bg-brand-red" key={step.title}>
              <div className="relative z-1 mx-auto mb-[17px] size-[97px] max-[767px]:ml-0 max-[767px]:size-[70px]">
                ...
                {index < whiteLabelWebsiteDesignProcess.length - 1 ? (
                  <svg className="absolute top-1/2 left-full -z-1 h-[13px] w-[198px] -translate-y-1/2 overflow-visible max-[1199px]:w-[138px] max-[991px]:w-[78px] max-[767px]:hidden" viewBox="0 0 204 13" preserveAspectRatio="none" aria-hidden="true">
        ...
        <Container className="max-[575px]:px-4">
          ...
          <div className="wrapper -mx-12 -mb-20 flex flex-wrap justify-center max-[1199px]:-mx-[30px] max-[1199px]:-mb-10 max-[767px]:m-0">
            {whiteLabelWebsiteDesignIndustries.map((item, index) => (
              <article
                className={cn(
                  "col relative mb-20 w-1/3 px-12 text-center max-[1199px]:mb-10 max-[1199px]:px-[30px] max-[991px]:w-1/2 max-[991px]:pb-10 max-[767px]:mb-[30px] max-[767px]:w-full max-[767px]:px-0 max-[767px]:pb-[30px]",
                  index < whiteLabelWebsiteDesignIndustries.length - 1 &&
                    "before:absolute before:top-full before:left-0 before:hidden before:h-px before:w-full before:bg-[linear-gradient(to_right,transparent,#333,transparent)] before:opacity-20 max-[991px]:before:block",
                  index !== whiteLabelWebsiteDesignIndustries.length - 1 &&
                  ...
                  (index === 1 || index === 3) && "max-[991px]:after:hidden",
