  ...
  return (
    <section className={className} data-section="features" id="features">
      <Container>
        ...
        <div className="wrapper -mx-[25px] flex flex-wrap items-center max-[1199px]:-mx-[15px] max-[992px]:-mx-[12px] max-[767px]:mx-0">
          {/* Left column */}
          <div className="features-col-1 w-[32.19%] px-[25px] max-[1199px]:w-[34%] max-[1199px]:px-[15px] max-[992px]:w-[36%] max-[992px]:px-[12px] max-[767px]:order-2 max-[767px]:w-full max-[767px]:px-0">
          ...
          {/* Center Column */}
          <div className="features-col-2 w-[35.6%] px-[25px] text-center max-[1199px]:w-[32%] max-[1199px]:px-[15px] max-[992px]:w-[28%] max-[992px]:px-[12px] max-[767px]:order-1 max-[767px]:mb-8 max-[767px]:w-full max-[767px]:px-0">
          ...
          {/* Right column */}
          <div className="features-col-3 w-[32.19%] px-[25px] max-[1199px]:w-[34%] max-[1199px]:px-[15px] max-[992px]:w-[36%] max-[992px]:px-[12px] max-[767px]:order-3 max-[767px]:w-full max-[767px]:px-0">
            <div className="features-text">
              <ul className="m-0 list-none p-0">
