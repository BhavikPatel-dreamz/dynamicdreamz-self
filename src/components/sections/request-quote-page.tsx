      ...
      <section className="request-quote-sec relative -mt-[111px] overflow-hidden p-0">
        <Container className="min-[1300px]:!max-w-[1360px] min-[1300px]:!px-10">
          <div className="request-quote-main">
            <div className="wrapper flex max-[991px]:flex-col-reverse">
              <div className="left-col-wrapper relative w-1/2 before:absolute before:top-0 before:right-0 before:-z-10 before:h-full before:w-[100vw] before:bg-[#fbf7ed] before:content-[''] max-[991px]:w-full max-[991px]:before:left-1/2 max-[991px]:before:right-1/2 max-[991px]:before:-ml-[50vw] max-[991px]:before:-mr-[50vw]">
                <QuoteLeftColumn />
              </div>
              <QuoteForm />
            </div>
