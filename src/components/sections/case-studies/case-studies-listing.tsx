            ...
            <div className="mx-auto max-w-[1170px]">
              <div className="cs-filter grid grid-cols-[minmax(260px,1fr)_260px_260px] items-center gap-3 rounded-[20px] border-[1.5px] border-[rgba(18,18,18,0.1)] bg-white p-[13px] shadow-[0_8px_30px_rgba(40,40,40,0.04)] max-[991px]:grid-cols-2 max-[991px]:gap-[13px] max-[767px]:grid-cols-1">
                <label className="cs-search relative w-full max-[991px]:col-span-2 max-[767px]:col-span-1">
                  ...
                  <input value={searchQuery} onChange={(event) => { setSearchQuery(event.target.value); setVisibleCount(BATCH_SIZE); }} type="search" placeholder={caseStudiesUiCopy.searchPlaceholder} className="h-[50px] w-full rounded-[10px] border border-[rgba(40,40,40,0.12)] bg-[rgba(255,255,255,0.05)] pl-11 pr-4 font-sans text-sm font-medium text-[#282828] outline-none placeholder:text-[#282828]/80 focus:border-[#ad5151]" />
