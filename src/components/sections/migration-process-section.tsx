...
function StepItem({ step }: { step: MigrationProcessStepItem }) {
  return (
    <div className="migration-step-box border-b-[1.5px] border-[#efefef] first:border-t-[1.5px]">
      <article className="migration-step-details flex items-center py-8 max-[767px]:flex max-[767px]:items-start max-[767px]:py-5">
...
export function MigrationProcessSection({
  ...
  const isCentered = className.includes("text-center") || Boolean(content.description);
      ...
      <Container>
        <div
          className={`title mb-10 ${
            isCentered ? "text-center mx-auto max-w-[850px]" : "max-w-[850px]"
          } max-[767px]:mb-6`}
        >
