...
export function CaseStudyDetailHero({ caseStudy }: CaseStudyDetailHeroProps) {
  ...
  return (
    <section className="relative pt-[190px] max-[992px]:pt-[140px]" aria-labelledby="case-study-title">
      ...
      <div className="relative mt-10 before:absolute before:top-1/2 before:right-0 before:-z-10 before:h-[550px] before:w-1/3 before:-translate-y-1/2 before:rounded-l-[20px] before:bg-[linear-gradient(97deg,#15c064_28.5%,#00d1ff_91.82%)] before:opacity-10 before:content-[''] max-[1199px]:before:h-[470px] max-[992px]:before:hidden">
        <Container className="max-[575px]:px-5">
          <div className="grid grid-cols-[47%_50%] items-center justify-between gap-[3%] max-[992px]:flex max-[992px]:flex-col-reverse max-[992px]:gap-0">
            <div className="max-[992px]:mt-10 max-[992px]:w-full">
              <h1
                id="case-study-title"
            ...
            <div className="flex w-full justify-start max-[992px]:justify-center">
              <div className="relative w-full max-w-[571px] after:absolute after:right-[-52px] after:bottom-1 after:-z-10 after:h-3 after:w-[122px] after:bg-[radial-gradient(circle,#000_0%,rgba(164,164,164,0)_70%)] after:opacity-20 after:blur-[3px] after:content-[''] before:absolute before:bottom-1 before:left-[-52px] before:-z-10 before:h-3 before:w-[122px] before:bg-[radial-gradient(circle,#000_0%,rgba(164,164,164,0)_70%)] before:opacity-20 before:blur-[3px] before:content-[''] max-[1299px]:after:right-[-28px] max-[1299px]:after:w-[100px] max-[1299px]:before:left-[-30px] max-[1299px]:before:w-[100px] max-[992px]:max-w-[680px] max-[767px]:after:right-[-20px] max-[767px]:after:w-[50px] max-[767px]:before:left-[-20px] max-[767px]:before:w-[50px]">
                <Image
