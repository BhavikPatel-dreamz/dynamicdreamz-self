  ...
  return (
    <div className="font-sans leading-[30.4px]">
      <ServiceHeroSection
        ...
        variant="centered"
        className="inner-hero-sec relative overflow-hidden bg-white pt-[250px] pb-16 border-b-[1.5px] border-[#dfdfdf] max-[1199px]:pt-[200px] max-[991px]:pt-[140px] max-[991px]:pb-[50px]"
      />
      <ShopifyMigrationServicesSection
        items={shopifyMigrationServices}
        className="migration-services-sec pt-16 pb-0 max-[991px]:pt-[50px]"
      />
      <AiAutomationSection
        content={shopifyMigrationAiAutomation}
        className="smarter-shopify-store mt-20 bg-[#171E16] py-20 text-white max-[991px]:mt-10 max-[991px]:py-[50px]"
      />
      <AiDiscoverySection
        content={shopifyMigrationAiDiscovery}
        variant="cards"
        className="preparing-store pt-20 pb-0 max-[991px]:pt-[50px]"
      />
      <PortfolioShowcaseSection
        className="our-work-sec py-20 max-[991px]:py-[50px] max-[767px]:pt-0 max-[767px]:pb-[50px]"
        content={shopifyMigrationPortfolio}
      />
      <HappyClientSection className="happy-client-sec pt-0 pb-20 overflow-hidden max-[991px]:pb-[50px]" />
      <FaqSection
