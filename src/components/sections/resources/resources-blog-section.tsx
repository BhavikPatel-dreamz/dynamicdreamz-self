  ...
  return (
    <section className="blog-carousel overflow-hidden py-20" aria-labelledby="resources-blog-title">
      <Container className="min-[1440px]:!max-w-[1180px]">
        <h2 id="resources-blog-title" className="resources-right-title relative mb-7 pl-5 text-[50px] leading-[66px] font-medium before:absolute before:top-1/2 before:left-0 before:h-[34px] before:w-[5px] before:-translate-y-1/2 before:bg-[linear-gradient(111.61deg,#15c064_-0.6%,#00d1ff_92.42%)] max-[991px]:text-[40px] max-[991px]:leading-[50px] max-[767px]:text-[30px] max-[767px]:leading-10">Shopify Blogs</h2>
        <div
