...
export function HiringProcessSection({
  ...
  return (
    <section className="hiring-process-sec py-20 max-[992px]:py-12.5 max-[767px]:py-12.5">
      <Container>
        <div className="text-center">
          <h2 className="mb-[15px] font-sans text-[35px] leading-[48.475px] font-bold tracking-[-0.7px] text-ink max-[992px]:text-[30px] max-[992px]:leading-10 max-[767px]:text-2xl max-[767px]:leading-8.25 max-[767px]:tracking-[-0.48px]">
            {content.heading}
          </h2>
        ...
        <ol className="mt-[55px] grid grid-cols-4 max-[992px]:grid-cols-2 max-[992px]:gap-y-[30px] max-[767px]:mt-[30px] max-[767px]:grid-cols-1">
          {content.items.map((item, index) => {
            const hasDesktopConnector = index < content.items.length - 1;

            return (
              <li className="relative px-2.5 text-center max-[992px]:px-5 max-[767px]:px-0" key={item.title}>
                <div
