...
export function WorkCultureSection() {
  return (
    <section
      className="pt-20 pb-0 max-[991px]:pt-[50px]"
      data-life="culture"
      ...
      <Container>
        ...
        >
          {workCulture.values.map((value, index) => (
            <article
              className={cn(
                "w-1/2 border-[#efefef] transition-shadow duration-300 hover:shadow-[-10px_4px_30px_rgba(0,38,31,0.06)] max-[991px]:w-full max-[767px]:rounded-[10px] max-[767px]:!border-[1.3px]",
                index % 2 === 0 && "border-r-[1.3px]",
                index < workCulture.values.length - 2 && "border-b-[1.3px]",
                index === workCulture.values.length - 2 &&
                  "max-[991px]:border-b-[1.3px]",
            ...
            >
              ...
              >
                ...
                <div className="w-[calc(100%-115px)] max-[1199px]:w-[calc(100%-84px)] max-[767px]:w-full">
                  <h3 className="mb-[5px] text-xl leading-[28.8px] font-bold text-ink max-[991px]:text-[18px] max-[991px]:leading-[26px]">
                    {value.title}
                  </h3>
