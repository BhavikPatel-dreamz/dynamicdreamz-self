...
export function AgencyOverviewSection() {
  return (
    <section className="min-h-[766.2px] min-[768px]:max-[991px]:min-h-[876.27px] max-[767px]:min-h-[860.72px]">
      <Container>
        <div className="global_agency_col_wrap flex h-[766.2px] justify-between overflow-hidden rounded-[30px] bg-pale-blue min-[768px]:max-[991px]:h-[876.27px] min-[768px]:max-[991px]:min-h-[876.27px] min-[768px]:max-[991px]:flex-col max-[767px]:h-[860.72px] max-[767px]:flex-col max-[767px]:rounded-[20px]">
          <div className="content_left_section mx-[37px] ml-15 w-[492px] shrink-0 py-[105px] max-[1199px]:ml-5 max-[1199px]:w-[44%] max-[1199px]:basis-[44%] max-[991px]:m-0 max-[991px]:h-[599.27px] max-[991px]:w-full max-[991px]:basis-[599.27px] max-[991px]:px-[25px] max-[991px]:py-[50px] max-[767px]:h-[602.72px] max-[767px]:basis-[602.72px] max-[767px]:px-[17px] max-[767px]:pt-[35px] max-[767px]:pb-[63px]">
