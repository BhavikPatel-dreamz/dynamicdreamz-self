    ...
    <section className="min-h-[883px] overflow-hidden bg-white pt-20 pb-[60px] min-[768px]:max-[992px]:min-h-[806.61px] min-[768px]:max-[992px]:py-[50px] max-[767px]:min-h-[722.33px] max-[767px]:py-[50px]">
      <Container>
        ...
        <div className="mt-[50px] flex justify-center max-[767px]:mt-[22px]">
          <ButtonLink className="min-h-[49px] px-6 py-[15px] text-base leading-[normal] normal-case max-[992px]:min-h-[42px] max-[992px]:py-3 max-[992px]:text-sm" variant="dark" href={homeSectionCopy.viewAllBlogsCtaHref}>{homeSectionCopy.viewAllBlogsCta}</ButtonLink>
        </div>
      </Container>
    </section>
  );
