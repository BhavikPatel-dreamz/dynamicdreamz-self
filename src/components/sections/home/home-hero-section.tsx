  ...
  return (
    <section className="overflow-hidden bg-[linear-gradient(180deg,#fbeed5_16.38%,rgb(251_238_213/0%)_100%)]">
      <Container home className="pt-[175px] text-center min-[768px]:max-[991px]:pt-[135px] max-[767px]:pt-[95px]">
        ...
        <h1 className="mx-auto mb-4 max-w-[1100px] text-[56px] leading-[1.14] font-medium text-ink min-[768px]:max-[991px]:text-[38px] min-[768px]:max-[991px]:leading-12 max-[767px]:max-w-[358px] max-[767px]:text-[27px] max-[767px]:leading-[37px]">
