...
|---|---|---|---|
| 1 | Hero (`Dawn Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features Of Dawn Theme (6 icon cards) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Dawn Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`dawn-theme-customization-service-img.webp`).
...
- Unique theme hero asset saved under `public/assets/dawn-theme-customization/hero/`:
  - `hero/dawn-theme-customization-service-img.webp` (601x462 WebP, 24KB)
