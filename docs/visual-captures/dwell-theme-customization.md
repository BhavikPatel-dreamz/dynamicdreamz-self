...
|---|---|---|---|
| 1 | Hero (`Dwell Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features Of Dwell Theme (3 highlight cards + 9 icon cards) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Dwell Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`dwell-theme-customization-service-img.webp`).
...
- Feature preview highlight cards:
  - `public/assets/dwell-theme-customization/features/warmth-that-welcomes-img.webp` (unique)
  - `public/assets/dwell-theme-customization/features/intuitive-product-discovery-img.webp` (unique)
...
- Unique theme hero asset saved under `public/assets/dwell-theme-customization/hero/`:
  - `hero/dwell-theme-customization-service-img.webp` (601x462 WebP, 25KB)
