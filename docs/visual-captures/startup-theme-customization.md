...
|---|---|---|---|
| 1 | Hero (`Startup Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features of Startup Theme (7 icon cards with descriptions) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Startup Theme Customization (7 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`startup-theme-customization-service-img.webp`).
...
- Unique theme hero asset saved under `public/assets/startup-theme-customization/hero/`:
  - `hero/startup-theme-customization-service-img.webp` (601x462 WebP, 15KB)
