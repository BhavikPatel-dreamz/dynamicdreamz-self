# Visual Parity Capture: Vision Theme Customization

- **Route**: `/vision-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/vision-theme-customization/`
...
|---|---|---|---|
| 1 | Hero (`Vision Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features of Vision Theme (8 icon cards with descriptions) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Vision Theme Customization (7 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`vision-theme-customization-service-img.webp`).
...
- Feature icons reused directly from canonical paths:
  ...
  - `/assets/sense-theme-customization/features/optimized-for-speed.svg`
...
- Unique theme hero asset saved under `public/assets/vision-theme-customization/hero/`:
  - `hero/vision-theme-customization-service-img.webp` (601x462 WebP, 23KB)
