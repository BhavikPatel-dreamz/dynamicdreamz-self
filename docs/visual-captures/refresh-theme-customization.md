# Visual Parity Capture: Refresh Theme Customization

- **Route**: `/refresh-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/refresh-theme-customization/`
...
- `/wp-content/themes/dynamicdreamz/assets/css/services/main.css`
  ...
  - `.three_col_icon_sec` (features section with 6 icon cards with descriptions and rounded-15px borders `#efefef`)
...
|---|---|---|---|
| 1 | Hero (`Refresh Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features Of Refresh Theme (6 icon cards with descriptions) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Refresh Theme Customization (7 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`refresh-theme-customization-services-img.webp`).
...
- Unique theme hero asset saved under `public/assets/refresh-theme-customization/hero/`:
  - `hero/refresh-theme-customization-services-img.webp` (601x462 WebP, 25KB)
