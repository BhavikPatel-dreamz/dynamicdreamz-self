...
|---|---|---|---|
| 1 | Hero (`GeneratePress Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands | `IndustryBrandsSection` | Reused |
| 3 | Features Of GeneratePress Theme (7 cards) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of GeneratePress Theme Customization (8 cards) | `ShopifyReasonsSection` | Reused |
| 5 | Our GeneratePress Theme Customization Services (6 cards) | `ShopifyServicesSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x474 WebP image (`generatepress-theme-customization-service-img.webp`).
...
- 10 brand partner logos reused directly from `public/assets/clients/`:
  ...
  - `nelter.svg`
  - `circuit-city.svg`
- 3 feature icons reused directly from `public/assets/astra-theme-customization/features/`:
...
- Unique theme assets cleanly saved under `public/assets/generatepress-theme-customization/` with clean kebab-case names:
  - `hero/generatepress-theme-customization-service-img.webp`
  - `features/mobile-responsive-design.svg`
  - `features/modular-design.svg`
  - `features/customizable-layouts.svg`
  - `features/secure-and-stable.svg`
