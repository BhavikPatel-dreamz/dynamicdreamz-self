# Visual Parity Capture: Impact Theme Customization

- **Route**: `/impact-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/impact-theme-customization/`
...
- `/wp-content/themes/dynamicdreamz/assets/css/services/main.css`
  ...
  - `.shopify-customization-services-sec` (benefits grid with gradient background, white cards, hover gradient border, 8 cards)
...
|---|---|---|---|
| 1 | Hero (`Impact Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features of Impact Theme (8 icon cards with descriptions) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Impact Theme Customization (8 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`impact-theme-customization-service-img.webp`).
...
- Feature icons reused directly from canonical paths:
  - `/assets/newsblogger-theme-customization/features/multiple-gallery-layouts.svg`
  ...
  - `/assets/stiletto-theme-customization/features/built-in-marketing-and-promotional-tools.svg`
...
- Unique theme hero asset saved under `public/assets/impact-theme-customization/hero/`:
  - `hero/impact-theme-customization-service-img.webp` (601x462 WebP, 28KB)
