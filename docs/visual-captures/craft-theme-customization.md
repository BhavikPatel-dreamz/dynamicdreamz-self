# Visual Parity Capture: Craft Theme Customization

- **Route**: `/craft-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/craft-theme-customization/`
...
|---|---|---|---|
| 1 | Hero (`Craft Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features of Craft Theme (8 icon cards with descriptions) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Craft Theme Customization (8 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`craft-theme-customization-service-img.webp`).
...
- Unique theme hero asset saved under `public/assets/craft-theme-customization/hero/`:
  - `hero/craft-theme-customization-service-img.webp` (601x462 WebP, 24KB)
