...
|---|---|---|---|
| 1 | Hero (`Kadence Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands | `IndustryBrandsSection` | Reused |
| 3 | Features Of Kadence Theme (7 cards) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Kadence Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
| 5 | Our Kadence Theme Customization Services (6 cards) | `ShopifyServicesSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x474 WebP image (`kadence-theme-customization-service-img.webp`).
...
- 10 brand partner logos reused directly from `public/assets/clients/`:
  ...
  - `nelter.svg`
  - `circuit-city.svg`
- 5 feature icons reused directly from `public/assets/astra-theme-customization/features/`:
  - `lightning-fast-performance.svg`
  - `seo-optimized.svg`
  - `fully-responsive.svg`
  - `woocommerce-ready.svg`
  - `pre-built-templates.svg`
...
- Unique theme assets cleanly saved under `public/assets/kadence-theme-customization/` with clean kebab-case names:
  - `hero/kadence-theme-customization-service-img.webp`
  - `features/drag-and-drop-header-footer-builder.svg`
  - `features/custom-hooks-and-filters.svg`
