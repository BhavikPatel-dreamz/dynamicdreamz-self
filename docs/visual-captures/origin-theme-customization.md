# Visual Parity Capture: Origin Theme Customization

- **Route**: `/origin-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/origin-theme-customization/`
...
|---|---|---|---|
| 1 | Hero (`Origin Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features Of Origin Theme (7 icon cards with descriptions) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Origin Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`origin-theme-customization-service-img.webp`).
...
- Unique theme hero asset saved under `public/assets/origin-theme-customization/hero/`:
  - `hero/origin-theme-customization-service-img.webp` (601x462 WebP, 35KB)
