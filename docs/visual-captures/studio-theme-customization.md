...
- `/wp-content/themes/dynamicdreamz/assets/css/services/main.css`
  - `.theme-customization-service-sec` (hero layout, 50%/50% split, `.review-wrap { display: none; }`, bottom-aligned hero graphic, internal `/request-quote` CTA "request a quote")
  - `.three_col_icon_sec` (features section with 6 icon cards with titles, descriptions, and rounded-15px borders `#efefef`)
...
|---|---|---|---|
| 1 | Hero (`Studio Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features of Studio Theme (6 icon cards) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Studio Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`studio-theme-customization-service-img.webp`).
...
- Feature icons reused directly from canonical paths:
  ...
  - `/assets/bloghash-theme-customization/features/social-media-interaction.svg`
...
- Unique theme hero asset saved under `public/assets/studio-theme-customization/hero/`:
  - `hero/studio-theme-customization-service-img.webp` (601x462 WebP, 19KB)
