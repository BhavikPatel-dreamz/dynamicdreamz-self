# Visual Parity Capture: Ritual Theme Customization

- **Route**: `/ritual-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/ritual-theme-customization/`
...
- `/wp-content/themes/dynamicdreamz/assets/css/services/main.css`
  ...
  - `.three_col_icon_sec` (features section with 3 visual preview highlight cards followed by 7 icon cards with rounded-15px borders `#efefef`)
...
|---|---|---|---|
| 1 | Hero (`Ritual Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features Of Ritual Theme (3 highlight cards + 7 icon cards) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Ritual Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`ritual-theme-customization-services-img.webp`).
...
- Feature preview highlight cards:
  - `public/assets/ritual-theme-customization/features/stylish-luxury-layouts-img.webp` (unique)
  - `public/assets/ritual-theme-customization/features/exclusive-and-refined-vibes-img.webp` (unique)
...
- Feature icons reused directly from canonical paths:
  ...
  - `/assets/pitch-theme-customization/features/slideshow-video-support.svg`
...
- Unique theme hero asset saved under `public/assets/ritual-theme-customization/hero/`:
  - `hero/ritual-theme-customization-services-img.webp` (601x462 WebP, 17KB)
