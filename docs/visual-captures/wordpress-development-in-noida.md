...
| Source | Details |
|---|---|
| Rendered Live Page & View Page Source | Captured title ("#1 Company For WordPress Development in Noida | Dynamic Dreamz"), description, canonical (`https://www.dynamicdreamz.com/wordpress-development-in-noida/`), 9 content sections, images, alts, and links |
...
| Live Screenshots Captured | Edge headless captures at 1440px (`scratch/wordpress-noida/live-desktop-full.png`), 768px (`scratch/wordpress-noida/live-tablet.png`), and 390px (`scratch/wordpress-noida/live-mobile.png`) |
