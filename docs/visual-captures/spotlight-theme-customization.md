# Visual Parity Capture: Spotlight Theme Customization

- **Route**: `/spotlight-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/spotlight-theme-customization/`
...
- `/wp-content/themes/dynamicdreamz/assets/css/services/main.css`
  ...
  - `.faq-sec` (accordion items with active/expanded states, 5 FAQs)
...
|---|---|---|---|
| 1 | Hero (`Spotlight Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features Of Spotlight Theme (7 icon cards with descriptions) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Spotlight Theme Customization (7 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`spotlight-theme-customization-services-img.webp`).
...
- Unique theme hero asset saved under `public/assets/spotlight-theme-customization/hero/`:
  - `hero/spotlight-theme-customization-services-img.webp` (601x462 WebP, 19KB)
