# Visual Parity Capture: Atelier Theme Customization

- **Route**: `/atelier-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/atelier-theme-customization/`
...
|---|---|---|---|
| 1 | Hero (`Atelier Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features Of Atelier Theme (3 highlight cards + 9 icon cards) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Atelier Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`atelier-theme-customization-service-img.webp`).
...
- Feature preview highlight cards:
  - `public/assets/atelier-theme-customization/features/elegant-and-curated-img.webp` (unique)
  - `public/assets/atelier-theme-customization/features/favors-editorial-design-img.webp` (unique)
...
- Feature icons reused directly from canonical paths:
  ...
  - `public/assets/atelier-theme-customization/features/high-resolution-image-support.svg` (unique)
...
- Unique theme hero asset saved under `public/assets/atelier-theme-customization/hero/`:
  - `hero/atelier-theme-customization-service-img.webp` (601x462 WebP, 20KB)
