...
|---|---|---|---|
| 1 | Hero (`OceanWP Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands | `IndustryBrandsSection` | Reused |
| 3 | Features Of OceanWP Theme (7 cards) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of OceanWP Theme Customization (7 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x474 WebP image (`oceanwp-theme-customization-service-img.webp`).
...
- Unique theme assets cleanly saved under `public/assets/oceanwp-theme-customization/` with clean kebab-case names:
  - `hero/oceanwp-theme-customization-service-img.webp`
  - `features/multiple-demo-sites.svg`
  - `features/third-party-plugin-support.svg`
