...
|---|---|---|---|
| 1 | Hero (`Kubio Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands | `IndustryBrandsSection` | Reused |
| 3 | Features Of Kubio Theme (7 cards) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Kubio Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 1219x948 WebP image (`kubio-theme-customization-service-img.webp`).
...
- Unique theme assets cleanly saved under `public/assets/kubio-theme-customization/` with clean kebab-case names:
  - `hero/kubio-theme-customization-service-img.webp`
