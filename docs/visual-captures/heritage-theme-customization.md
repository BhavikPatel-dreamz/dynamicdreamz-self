# Visual Parity Capture: Heritage Theme Customization

- **Route**: `/heritage-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/heritage-theme-customization/`
...
- `/wp-content/themes/dynamicdreamz/assets/css/services/main.css`
  ...
  - `.three_col_icon_sec` (features section with 3 visual preview highlight cards followed by 6 icon cards with rounded-15px borders `#efefef`)
...
|---|---|---|---|
| 1 | Hero (`Heritage Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features Of Heritage Theme (3 highlight cards + 6 icon cards) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Heritage Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`heritage-theme-customization-services-img.webp`).
...
- Feature preview highlight cards:
  - `public/assets/heritage-theme-customization/features/editorial-storytelling-img.webp` (unique)
  - `public/assets/heritage-theme-customization/features/tactile-and-expressive-img.webp` (unique)
...
- Feature icons reused directly from canonical paths:
  ...
  - `/assets/astra-theme-customization/features/highly-customizable.svg`
  - `/assets/generatepress-theme-customization/features/mobile-responsive-design.svg`
  - `/assets/impulse-theme-customization/features/collection-page-sidebar.svg`
...
- Unique theme hero asset saved under `public/assets/heritage-theme-customization/hero/`:
  - `hero/heritage-theme-customization-services-img.webp` (601x462 WebP, 19KB)
