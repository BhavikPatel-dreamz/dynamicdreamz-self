# Visual Parity Capture: Trade Theme Customization

- **Route**: `/trade-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/trade-theme-customization/`
...
|---|---|---|---|
| 1 | Hero (`Trade Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features Of Trade Theme (7 icon cards with descriptions) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Trade Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`trade-theme-customization-service-img.webp`).
...
- Unique theme hero asset saved under `public/assets/trade-theme-customization/hero/`:
  - `hero/trade-theme-customization-service-img.webp` (601x462 WebP, 24KB)
