# Visual Parity Capture: Publisher Theme Customization

- **Route**: `/publisher-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/publisher-theme-customization/`
...
- `/wp-content/themes/dynamicdreamz/assets/css/services/main.css`
  ...
  - `.three_col_icon_sec` (features section with 7 icon cards with descriptions and rounded-15px borders `#efefef`)
  ...
  - `.our-work-sec` (Shopify portfolio project showcase with 2 project cards: Tap Fit and Ruby Olive)
...
|---|---|---|---|
| 1 | Hero (`Publisher Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features Of Publisher Theme (7 icon cards with descriptions) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Publisher Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
...
| 7 | Snippets of Shopify Theme Customization Portfolio (2 projects: Tap Fit, Ruby Olive) | `PortfolioShowcaseSection` & `PortfolioProjectCard` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`publisher-theme-customization-service-img.webp`).
...
- Feature icons reused directly from canonical paths:
  ...
  - `/assets/oceanwp-theme-customization/features/multiple-demo-sites.svg`
...
- Unique portfolio screenshots saved under `public/assets/publisher-theme-customization/portfolio/`:
  - `tap-fit.webp`
  - `ruby-olive.webp`
- Unique theme hero asset saved under `public/assets/publisher-theme-customization/hero/`:
  - `hero/publisher-theme-customization-service-img.webp` (601x462 WebP, 27KB)
