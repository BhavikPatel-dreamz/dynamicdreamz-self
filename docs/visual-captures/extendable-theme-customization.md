# Visual Parity Capture: Extendable Theme Customization

- **Route**: `/extendable-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/extendable-theme-customization/`
...
|---|---|---|---|
| 1 | Hero (`Extendable Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands | `IndustryBrandsSection` | Reused |
| 3 | Features Of Extendable Theme (7 cards) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Extendable Theme Customization (9 cards) | `ShopifyReasonsSection` | Reused |
| 5 | Our Extendable Theme Customization Services (6 cards) | `ShopifyServicesSection` | Reused |
...
- **Hero Image**: Bottom-aligned 1202x948 WebP image (`extendable-theme-customization-service-img.webp`).
...
- Unique theme assets cleanly saved under `public/assets/extendable-theme-customization/` with clean kebab-case names:
  - `hero/extendable-theme-customization-service-img.webp`
