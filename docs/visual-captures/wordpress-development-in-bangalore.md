...
| Source | Details |
|---|---|
| Rendered Live Page & View Page Source | Captured title ("No.1 Company For WordPress Development in Bangalore | Dynamic Dreamz"), description, canonical (`https://www.dynamicdreamz.com/wordpress-development-in-bangalore/`), 9 content sections, images, alts, and links |
...
| Live Screenshots Captured | Edge headless captures at 1440px (`scratch/wordpress-bangalore/live-desktop-full.png`), 768px (`scratch/wordpress-bangalore/live-tablet.png`), and 390px (`scratch/wordpress-bangalore/live-mobile.png`) |
