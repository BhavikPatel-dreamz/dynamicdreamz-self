# Visual Parity Capture: Pipeline Theme Customization

- **Route**: `/pipeline-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/pipeline-theme-customization/`
...
|---|---|---|---|
| 1 | Hero (`Pipeline Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features of Pipeline Theme (8 icon cards with descriptions) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Pipeline Theme Customization (7 cards) | `ShopifyReasonsSection` | Reused |
| 5 | Our Shopify Theme Customization Services (5 cards) | `ShopifyServicesSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`pipeline-theme-customization-service-img.webp`).
...
- Feature icons reused directly from canonical paths:
  ...
  - `/assets/newsblogger-theme-customization/features/featured-posts-section.svg`
  - `/assets/be-yours-theme-customization/features/social-media-integration.svg`
...
- Unique theme hero asset saved under `public/assets/pipeline-theme-customization/hero/`:
  - `hero/pipeline-theme-customization-service-img.webp` (601x462 WebP, 40KB)
