# Visual Parity Capture: Woodstock Theme Customization

- **Route**: `/woodstock-theme-customization`
- **Live URL Reference**: `https://www.dynamicdreamz.com/woodstock-theme-customization/`
...
- `/wp-content/themes/dynamicdreamz/assets/css/services/main.css`
  ...
  - `.faq-sec` (accordion items with active/expanded states, 8 FAQs)
...
|---|---|---|---|
| 1 | Hero (`Woodstock Theme Customization Service`) | `ThemeHeroSection` | Reused |
| 2 | Trusted by Leading Brands (10 client logos) | `IndustryBrandsSection` | Reused |
| 3 | Features of Woodstock Theme (8 icon cards with descriptions) | `ThemeFeaturesSection` | Reused |
| 4 | Benefits of Woodstock Theme Customization (7 cards) | `ShopifyReasonsSection` | Reused |
...
- **Hero Image**: Bottom-aligned 601x462 WebP image (`woodstock-theme-customization-service-img.webp`).
...
- Feature icons reused directly from canonical paths:
  - `/assets/sense-theme-customization/features/clean-minimalistic-design.svg`
  - `/assets/impulse-theme-customization/features/fast-loading-speed.svg`
  ...
  - `/assets/newsblogger-theme-customization/features/translation-ready.svg`
...
- 7 benefit icons and 6 service icons reused from `public/assets/shopify-theme-customization/`.
...
- Unique theme hero asset saved under `public/assets/woodstock-theme-customization/hero/`:
  - `hero/woodstock-theme-customization-service-img.webp` (601x462 WebP, 27KB)
